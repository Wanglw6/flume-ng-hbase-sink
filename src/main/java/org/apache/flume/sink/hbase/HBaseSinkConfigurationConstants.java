...
public class HBaseSinkConfigurationConstants {
  ...
  public static final String dwConnection = "dwConnection";
  ...
  public static final String MONITORURL = "monitorUrl";
  public static final String CONFIGCENT_URL = "configcentUrl";
  public static final String DEFAULT_CLUSTER_TYPE = "TTP.SG.InternalNgx.BJ";
  public static final String DEFAULT_CLUSTER_NAMEOFTYPE = "HBase";
  public static final String CLUSTER_ENVIRONMENTAL = "clusterEnvironmental";
  public static final String CLUSTER_NAME_OF_TYPE = "clusterNameOfType";
